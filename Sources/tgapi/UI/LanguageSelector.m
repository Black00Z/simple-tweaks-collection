...
- (void)viewDidLoad {
    ...
    NSString *filePath = ROOT_PATH_NS(@"/Library/Application Support/TGExtra/TGExtra.bundle/langs.json");
...
- (void)loadLanguages {
    ...
    for (NSDictionary *language in self.languages) {
        NSString *localizationFilePath = [NSString stringWithFormat:@"%@/TGExtra.bundle/%@.lproj/Localizable.strings", ROOT_PATH_NS(@"/Library/Application Support/TGExtra"), language[@"code"]];

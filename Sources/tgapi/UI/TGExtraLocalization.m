...
- (void)loadDefault {
	...
	NSString *localizationFilePath = [NSString stringWithFormat:@"%@/TGExtra.bundle/%@.lproj/Localizable.strings", ROOT_PATH_NS(@"/Library/Application Support/TGExtra"), selectedLanguageCode];
